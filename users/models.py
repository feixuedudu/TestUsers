...
class User(AbstractUser):
    ...
    """
    name = models.CharField(max_length=20, default='第一次登入')
    sex = models.CharField(max_length=3, default='男')
    birthday = models.CharField(max_length=20, default='2018-3-23')
    job_number = models.CharField(max_length=10, default='0001')

    zhengzhi_mianmao = models.CharField(max_length=10, default='群众')
    zhengzhi_time = models.CharField(max_length=20, default='2018-3-23')

    job = models.CharField(max_length=30, default='工程师')
    job_time = models.CharField(max_length=20, default='2018-3-23')

    job_2 = models.CharField(max_length=30, default='员工')
    id_number = models.CharField(max_length=30, default='1000215455545')

    xue_li = models.CharField(max_length=30, default='本科')
    school = models.CharField(max_length=30, default='湖北理工')
    graduate_time = models.CharField(max_length=20, default='2018-3-23')
    job_join_time = models.CharField(max_length=20, default='2018-3-23')
    team_belong = models.CharField(max_length=20, default='训机')

    phone = models.CharField(max_length=30, default='13260642738')
